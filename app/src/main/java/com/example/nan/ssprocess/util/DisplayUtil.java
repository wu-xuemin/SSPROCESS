...
public class DisplayUtil {
	...
	public static int px2dip(float pxValue) {
		final float scale = SinSimApp.getApp().getResources().getDisplayMetrics().density;
	...
	public static int px2sp(float pxValue) {
		final float fontScale = SinSimApp.getApp().getResources().getDisplayMetrics().scaledDensity;
